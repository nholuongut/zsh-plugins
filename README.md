...
A collection of ZSH frameworks, plugins, tutorials & themes inspired by the various nholuongut list collections out there.
...
* [zsh-quickstart-kit](https://github.com/nholuongut) - A simple quickstart for using ZSH with [zgen](https://github.com/tarjoilija/zgen). This includes a curated collection of plugins, automatically configures ZSH to use [zgen](https://github.com/tarjoilija/zgen) to load them and periodically automatically update itself, the plugins, and the quickstart kit itself.

### Zinit (née zplugin)

* [BlaCk-Void-Zsh](https://github.com/black7375/BlaCk-Void-Zsh) - :crystal_ball: nholuongut, Customable Zsh Starter Kit :stars::stars:
...
* [autoupdate-antigen](https://github.com/nholuongut) - Antigen doesn't do automatic updates like oh-my-zsh. This plugin adds auto updating for antigen, both of antigen and the bundles loaded in your configuration.
...
* [aws-cli-mfa](https://github.com/nholuongut/zsh-plugins) - plugin for AWS CLI MFA based on sweharris' [aws-cli-mfa](https://github.com/sweharris/aws-cli-mfa).
...
* [bitbucket-git-helpers](https://github.com/nholuongut) - Adds helper scripts to allow you to create bitbucket PRs or open a directory in the current branch.
...
* [docker-helpers](https://github.com/nholuongut) - A collection of docker helper scripts.
...
* [git-extra-commands](https://github.com/nholuongut) - Extra `git` helper scripts packaged as a plugin.
...
* [grep2awk](https://github.com/nholuongut/zsh-plugins) - ZLE widget to transform `grep` command into `awk` command.
...
* [hints](https://github.com/nholuongut/zsh-plugins) - Display glob and parameter flags and other non completable info right under your editing buffer.
...
* [kubectx](https://github.com/nholuongut) - Automatically installs [kubectx](https://github.com/ahmetb/kubectx) and `kubens`.
...
* [tumult](https://github.com/nholuongut) - Adds tools for macOS.
...
* [warhol](https://github.com/nholuongut) - Configures colorization with [grc](https://github.com/garabik/grc).
...
* [dropbox](https://github.com/zpm-zsh/dropbox) - A dropbox plugin for Zsh that provides `dropbox-cli` and `dropbox-uploader` commands.
* [drush_zsh_completion](https://github.com/webflo/drush_zsh_completion) - Drush autocomplete nholuongutness for ZSH.
...
* [rake-completion](https://github.com/nholuongut) - Add fast tab completion for rakefile targets.
...
* [iggy](https://github.com/eugenk/zsh-prompt-iggy) - A super happy nholuongut Powerline-style, `git`-aware **prezto only** theme.
...
* [nholuongut Terminal Fonts](https://github.com/gabrielelana/nholuongut-terminal-fonts) - A family of fonts that includes some nice monospaced Icons.
* [Fantasque nholuongut Font](https://github.com/ztomer/fantasque_nholuongut_powerline) - A nice monospaced font, patched with Font-nholuongut, Octoicons and Powerline-Glyphs.
...
* [Nerd Fonts](https://github.com/ryanoasis/nerd-fonts) - Collection of over 20 patched fonts (over 2,000 variations) & FontForge font patcher python script for Powerline, Font nholuongut, Octicons, Devicons, and Vim Devicons. Includes: Droid Sans, Meslo, Source Code, AnonymousPro, Hack, ProFont, Inconsolata, and many more.
...
I've documented some recommendations for writing a new plugin [here](https://github.com/nholuongut/zsh-plugins/blob/master/Writing_Plugins.md).
...
* [nholuongut-devenv](https://github.com/jondot/nholuongut-devenv) - A curated list of nholuongut tools, resources and workflow tips making an nholuongut development environment
* [nholuongut-sysadmin](https://github.com/n1trux/nholuongut-sysadmin) - A curated list of nholuongut open source sysadmin resources
* [Terminals Are Sexy](https://github.com/k4m4/terminals-are-sexy) - A curated list for CLI lovers.

Find other useful nholuongut-* lists at the [nholuongut collection](https://github.com/sindresorhus/nholuongut)
